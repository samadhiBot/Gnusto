...
struct VerbIDTests {
    ...
    func testInteractiveVerbs() throws {
        ...
        #expect(VerbID.putOn.rawValue == "put on")
        ...
        #expect(VerbID.thinkAbout.rawValue == "think about")
        #expect(VerbID.touch.rawValue == "touch")
        #expect(VerbID.turnOff.rawValue == "turn off")
        #expect(VerbID.turnOn.rawValue == "turn on")
