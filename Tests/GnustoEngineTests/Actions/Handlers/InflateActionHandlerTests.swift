...
struct InflateActionHandlerTests {
    ...
    func testInflateCommand() async throws {
        ...
        let command = Command(verb: .inflate, directObject: "balloon", rawInput: "inflate balloon")
    ...
    func testInflateNonInflatableItem() async throws {
        ...
        let handler = InflateActionHandler()
        let command = Command(verb: .inflate, directObject: "coin", rawInput: "inflate coin")
        let context = ActionContext(command: command, engine: engine)
