...
// 🚀 ID Constants are now automatically generated by FrobozzMagicIDPlugin!
// The plugin scans source files for usage patterns like:
// - Location(id: .someID, ...)
// - Item(id: .someID, ...)
// - .to(.someLocation)
// - Player(in: .someLocation)
// And generates the corresponding LocationID and ItemID extensions.
