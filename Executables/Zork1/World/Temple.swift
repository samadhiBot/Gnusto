...
enum Temple {
    static let domeRoom = Location(.domeRoom)
        .name("Dome Room")
        .description(
            """
    ...
    static let egyptRoom = Location(.egyptRoom)
        .name("Egyptian Room")
        .description(
            """
    ...
    static let northTemple = Location(.northTemple)
        .name("Temple")
        .description(
            """
    ...
    static let torchRoom = Location(.torchRoom)
        .name("Torch Room")
        .description(
            """
...
extension Temple {
    ...
    static let candles = Item(.candles)
    ...
    static let engravings = Item(.engravings)
    ...
    static let pedestal = Item(.pedestal)
        .name("pedestal")
        .synonyms("pedestal")
    ...
    static let railing = Item(.railing)
        .name("wooden railing")
    ...
    static let sceptre = Item(.sceptre)
        .name("sceptre")
