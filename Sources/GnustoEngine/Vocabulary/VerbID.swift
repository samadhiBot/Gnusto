...
extension VerbID {
    ...
    public static let climbOn = VerbID("climb on")
    ...
    public static let thinkAbout = VerbID("think about")
    ...
    public static let turnOff = VerbID("turn off")
    public static let turnOn = VerbID("turn on")
...
extension VerbID {
    public static let climbDown = VerbID("climb down")
    public static let climbUp = VerbID("climb up")
    public static let enter = VerbID("enter")
    public static let exit = VerbID("exit")
    public static let getOff = VerbID("get off")
    public static let getOut = VerbID("get out")
    public static let jump = VerbID("jump")
    public static let jumpOff = VerbID("jump off")
    public static let jumpOut = VerbID("jump out")
    public static let leave = VerbID("leave")
    public static let lookDown = VerbID("look down")
    public static let lookUp = VerbID("look up")
