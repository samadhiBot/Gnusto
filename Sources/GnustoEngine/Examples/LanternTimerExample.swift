...
public func createLanternTimerDaemon() -> DaemonDefinition {
    return DaemonDefinition(
        ...
        case LanternConstants.lowBatteryThreshold:
            ...
            await engine.ioHandler.print("Your lantern is getting dim.", style: .strong)

        case 0:
            // Battery is fully depleted
            await engine.ioHandler.print("Your lantern has run out of power and is now dark.", style: .strong)
...
public func createLanternWarningFuse() -> FuseDefinition {
    return FuseDefinition(
        ...
        await engine.ioHandler.print("Your lantern is getting very dim and will soon run out of power!", style: .strong)
    }
}
