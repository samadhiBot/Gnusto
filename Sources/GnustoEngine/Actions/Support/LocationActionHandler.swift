...
/// - Returns: `true` if the handler fully handled the action (potentially blocking default
///            behavior), `false` otherwise.
/// - Throws: Allows handlers to throw errors if needed.
public typealias LocationActionHandler = @Sendable (GameEngine, LocationActionMessage) async throws -> Bool
